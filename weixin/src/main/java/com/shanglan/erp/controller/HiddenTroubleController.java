...
public class HiddenTroubleController {
    ...
    @RequestMapping(path = "/result/list/data",method = RequestMethod.GET)
    public AjaxResponse resultList(HiddenTroubleResultDTO hiddenTroubleResultDTO,@PageableDefault(value = 10,sort = "publicTime",direction = Sort.Direction.DESC) Pageable pageable){
        Page<HiddenTroubleResult> page = hiddenTroubleService.findAll(hiddenTroubleResultDTO,pageable);
        return AjaxResponse.success(page);
    }
