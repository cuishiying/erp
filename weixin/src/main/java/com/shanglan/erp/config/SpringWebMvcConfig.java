...
public class SpringWebMvcConfig extends WebMvcConfigurerAdapter {
	...
	private static DateTimeFormatter LocalMonthFormatter = DateTimeFormatter.ofPattern("yyyy-MM");
	...
	private static class LocalMonthSerializer extends JsonSerializer<LocalDate> {
		
		@Override
		public void serialize(LocalDate value, JsonGenerator gen, SerializerProvider serializers)
				throws IOException, JsonProcessingException {
			gen.writeString(value.format(LocalMonthFormatter));
		}
	}

	private static class LocalMonthDeserializer extends JsonDeserializer<LocalDate> {
		
		@Override
		public LocalDate deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
			System.out.println(jp.getText());
			return LocalDate.parse(jp.getText(), LocalMonthFormatter);
		}
	}
